            ...
            for (Element annotatedElement : roundEnv.getElementsAnnotatedWith(Factory.class)) {
                ...
                if (annotatedElement.getKind() != ElementKind.CLASS) {
                    throw new ProcessingException(annotatedElement,
                            "Only classes can be annotated with @%s", Factory.class.getSimpleName());
                }
                ...
                if (factoryClass == null) {
                    String qualifiedGorupName = annotatedClass.getQualifiedFactoryGroupName();
                    factoryClass = new FactoryGroupedClasses(qualifiedGorupName);
                    factoryClasses.put(qualifiedGorupName, factoryClass);
                }
        ...
        if (superClassElement.getKind() == ElementKind.INTERFACE) {
            ...
            while (true) {
                ...
                if (superClassType.getKind() == TypeKind.NONE) {
                    //Basic class (java.lang.Object) reached, so exit
